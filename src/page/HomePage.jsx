    ...
    <div className="flex h-screen bg-gradient-to-b from-blue-50/50 to-white w-full">
        ...
        <div className="p-4 border-t flex items-center justify-between bg-white">
          ...
          <button className="p-2 hover:bg-gray-200 rounded-md bg-white">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 3.5C8.41421 3.5 8.75 3.16421 8.75 2.75C8.75 2.33579 8.41421 2 8 2C7.58579 2 7.25 2.33579 7.25 2.75C7.25 3.16421 7.58579 3.5 8 3.5Z" fill="#6B7280"/>
              <path d="M8 8.75C8.41421 8.75 8.75 8.41421 8.75 8C8.75 7.58579 8.41421 7.25 8 7.25C7.58579 7.25 7.25 7.58579 7.25 8C7.25 8.41421 7.58579 8.75 8 8.75Z" fill="#6B7280"/>
              <path d="M8 14C8.41421 14 8.75 13.6642 8.75 13.25C8.75 12.8358 8.41421 12.5 8 12.5C7.58579 12.5 7.25 12.8358 7.25 13.25C7.25 13.6642 7.58579 14 8 14Z" fill="#6B7280"/>
            </svg>
          </button>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-row items-center justify-center text-center px-8">
        <div className="mb-80">
          ...
          Good morning, <span className="text-blue-600 whitespace-nowrap font-josefin">User Admin</span>
          </h1>
