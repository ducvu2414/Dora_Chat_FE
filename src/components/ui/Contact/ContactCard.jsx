            ...
            <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center space-x-4 flex-1 min-w-0">
                    <div
                        ...
                        style={{
                            backgroundColor: !contact.avatar || contact.avatar === "" ?
                                getColorFromName(contact.avatarColor || 'blue') : '#e2e8f0'
                        }}
                    >
                        {contact.avatar && contact.avatar !== "" ? (
                            ...
                            <span className={`font-medium text-lg ${(contact.avatarColor || '').toLowerCase() === 'white' ? 'text-gray-800' : 'text-white'}`}>
