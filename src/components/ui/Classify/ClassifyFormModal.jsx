...
export default function ClassifyFormModal({ onClose, onSubmit, initialData = {} }) {
                                    ...
                                    {colors.length > 0 ? (
                                        colors.map((color) => (
                                            <button
                                                ...
                                                className={`w-7 h-7 rounded-full border-2 flex items-center justify-center ${colorId === color._id ? "border-black" : "border-transparent"}`}
                            ...
                            <div className="mt-2 space-y-1 max-h-32 overflow-y-auto bg-gray-50 rounded-md p-2">
                                {selectedConversations.length === 0 ? (
                                    ...
                                    selectedConversations.map((id) => (
                                        ...
                                        >
                                            <span className="truncate pr-2">{getConversationName(id)}</span>
                                            <button
